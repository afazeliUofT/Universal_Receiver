...
python tests/regression_baseline_builds.py --config configs/target_cdlc_highmobility_paper_comparison.yaml
python tests/regression_phaseaware_identity.py --config configs/target_cdlc_highmobility_paper_comparison.yaml
python tests/regression_paper_cfgres_build.py --config configs/target_cdlc_highmobility_paper_comparison.yaml
python -m upair5g.cli eval \
  --config configs/target_cdlc_highmobility_paper_comparison.yaml \
