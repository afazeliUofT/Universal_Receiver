...
python tests/regression_baseline_builds.py --config configs/smoke_paper_comparison.yaml
python tests/regression_phaseaware_identity.py --config configs/smoke_paper_comparison.yaml
python tests/regression_paper_cfgres_build.py --config configs/smoke_paper_comparison.yaml
python -m upair5g.cli eval \
  --config configs/smoke_paper_comparison.yaml \
